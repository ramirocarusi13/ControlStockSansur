                    ...
                    <div class="box">
                        ...
                        <form action="{{ route('register.register') }}" method="post">
                            ...
                            <div class="field">
                                ...
                                @if (session('error_first_name'))
                                    <small style="color: red">{{ session('error_first_name') }} </small>
                                @endif
                            ...
                            <div class="field">
                                ...
                                @if (session('error_last_name'))
                                    <small style="color: red">{{ session('error_last_name') }} </small>
                                @endif
                            ...
                            <div class="field">
                                ...
                                @if (session('error_dni'))
                                    <small style="color: red">{{ session('error_dni') }} </small>
                                @endif
                            ...
                            <div class="field">
                                ...
                                @if (session('error_phone_number'))
                                    <small style="color: red">{{ session('error_phone_number') }} </small>
                                @endif
                            ...
                            <div class="field">
                                ...
                                @if (session('error_email'))
                                    <small style="color: red">{{ session('error_email') }} </small>
                                @endif
                            ...
                            <div class="field">
                                ...
                                @if (session('error_password'))
                                    <small style="color: red">{{ session('error_password') }} </small>
                                @endif
                            ...
                            <div class="field">
                                ...
                                @if (session('error_password_confirmation'))
                                    <small style="color: red">{{ session('error_password_confirmation') }} </small>
                                @endif
                            ...
                            <div class="level-item has-text-centered">
                                ...
                                <div class="field is-grouped pt-3">
                                    ...
                                    <div class="control">
                                        <a href="{{ route('login.view') }}"><button type="button" class="button is-link is-light">Cancelar</button></a>
                                    </div>
                                </div>
